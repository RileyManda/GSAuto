...
public class HubWashersAdapter extends RecyclerView.Adapter<HubWashersAdapter.HubWashersViewHolder> {

    List<ProductModelTwo> productModelTwos;
    Context context;

    public HubWashersAdapter(List<ProductModelTwo> productModelTwos, Context context) {
    ...
    @NonNull
    @Override
    public HubWashersViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.product_model,parent,false);
        return new HubWashersViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull HubWashersViewHolder holder, final int position) {
    ...
    public class HubWashersViewHolder extends RecyclerView.ViewHolder{

        TextView tvCode,tvSize,tvModel,tvPrice;
        CardView cardView;

        public HubWashersViewHolder(View itemView) {
            super(itemView);
