...
public class StudsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        studsAdapter = new StudsAdapter(productModels,getApplicationContext());
        recyclerView.setLayoutManager(new LinearLayoutManager(this));

        GetFirebaseData();

        recyclerView.setAdapter(studsAdapter);
    ...
    private void GetFirebaseData() {
        ...
        ref.orderByKey().startAt("44").limitToFirst(13).addChildEventListener(new ChildEventListener() {
            @Override
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                studsAdapter.notifyDataSetChanged();
            }
