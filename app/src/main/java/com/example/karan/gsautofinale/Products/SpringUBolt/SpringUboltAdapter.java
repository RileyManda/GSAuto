...
public class SpringUboltAdapter extends RecyclerView.Adapter<SpringUboltAdapter.SpringUboltViewHolder> {

    List<ProductModelTwo> productModelTwos;
    Context context;

    public SpringUboltAdapter(List<ProductModelTwo> productModelTwos, Context context) {
    ...
    @NonNull
    @Override
    public SpringUboltViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.product_model,parent,false);
        return new SpringUboltViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull SpringUboltViewHolder holder, final int position) {
    ...
    public class SpringUboltViewHolder extends RecyclerView.ViewHolder{

        TextView tvCode,tvSize,tvModel,tvPrice;
        CardView cardView;

        public SpringUboltViewHolder(View itemView) {
            super(itemView);
