...
public class AmbassadorAdapter extends RecyclerView.Adapter<AmbassadorAdapter.AmbassadorViewHolder> {

    List<ProductModel> productModels;
    Context context;

    public AmbassadorAdapter(List<ProductModel> productModels, Context context) {
    ...
    @NonNull
    @Override
    public AmbassadorViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(context).inflate(R.layout.product_model,parent,false);
        return new AmbassadorViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull AmbassadorViewHolder holder, final int position) {
    ...
    public class AmbassadorViewHolder extends RecyclerView.ViewHolder{

        TextView tvCode,tvSize,tvModel,tvPrice;
        CardView cardView;

        public AmbassadorViewHolder(View itemView) {
            super(itemView);
