...
public class SpringpinAdapter extends RecyclerView.Adapter<SpringpinAdapter.springpinViewHolder> {

    List<ProductModel> productModels;
    Context context;

    public SpringpinAdapter(List<ProductModel> productModels, Context context) {
    ...
    @NonNull
    @Override
    public springpinViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.product_model,parent,false);
        return new springpinViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull springpinViewHolder holder, final int position) {
    ...
    public class springpinViewHolder extends RecyclerView.ViewHolder{

        TextView tvCode,tvSize,tvModel,tvPrice;
        CardView cardView;

        public springpinViewHolder(View itemView) {
            super(itemView);
